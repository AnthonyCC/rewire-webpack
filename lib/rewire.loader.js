...
function rewireLoader(src) {
    src =
			...
			'var getImportGlobalsSrc = function(e){var t,n,r="",i=typeof global==="undefined"?window:global;e=e||[];for(t in i){if(t!=="global"&&e.indexOf(t)===-1){n=i[t];r+="var "+t+" = global."+t+"; "}}return r}; ' + 
            'eval(getImportGlobalsSrc()); ' +
